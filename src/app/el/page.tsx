  ...
  return (
    <div lang="el">
      <PageHero
        ...
        lead="Ιστοσελίδα, chat που απαντά από τη δική σας γνώση, αυτοματισμοί, και οι αριθμοί σας σε μία ζωντανή εικόνα. Μία ομάδα, μία προσφορά — για επιχειρήσεις στη Λεμεσό και σε όλη την Κύπρο."
        ctas={[
      ...
      <Tldr
        rows={[
          ...
          {
            k: "Για ποιους",
            v: "Για επιχειρήσεις που τώρα ξεκινούν, και για επιχειρήσεις που το site και τα συστήματά τους έχουν μείνει πίσω. Πάρτε ένα κομμάτι, ή αναθέστε μας τα όλα με μία προσφορά.",
          },
          {
            k: "Πώς ξεκινάτε",
            v: "Κλείστε το δωρεάν 30λεπτο ραντεβού — φεύγετε με γραπτή σταθερή τιμή σε 48 ώρες. Ή δοκιμάστε πρώτα το chat στο site σας, δωρεάν.",
          },
        ]}
      />
