...
const TWO_LINES_LAST_MOD = "2026-09-06"; // /studio + /suite: the App and the Studio as two lines
const EL_TWO_LINES_LAST_MOD = "2026-09-06"; // their Greek twins, same day
...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    },
    {
      ...
      changeFrequency: "monthly",
      priority: 0.9,
      alternates: pair("/studio", "/el/studio"),
    },
    {
      url: `${SITE_URL}/suite`,
      lastModified: TWO_LINES_LAST_MOD,
      changeFrequency: "monthly",
      priority: 0.8,
      alternates: pair("/suite", "/el/suite"),
    },
    {
      url: `${SITE_URL}/el/studio`,
      lastModified: EL_TWO_LINES_LAST_MOD,
      changeFrequency: "monthly",
      priority: 0.9,
      alternates: pair("/studio", "/el/studio"),
    },
    {
      url: `${SITE_URL}/el/suite`,
      lastModified: EL_TWO_LINES_LAST_MOD,
      changeFrequency: "monthly",
      priority: 0.8,
      alternates: pair("/suite", "/el/suite"),
