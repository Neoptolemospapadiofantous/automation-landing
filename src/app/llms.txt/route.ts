...
- Greek pages (ελληνικά): the marketing pages below exist in Greek — home, website builds, cold outreach, email automation, pricing, dashboards/analytics, the audit booking form, and all four role pages — at ${SITE_URL}/el, ${SITE_URL}/el/website-build, ${SITE_URL}/el/outreach, ${SITE_URL}/el/email-automation, ${SITE_URL}/el/pricing, ${SITE_URL}/el/what-works, ${SITE_URL}/el/audit and ${SITE_URL}/el/roles/{lead-qualification,sales,customer-support,onboarding} — same facts and prices, native Greek copy. English only for now: the two-lines pages ${SITE_URL}/studio and ${SITE_URL}/suite, and the legal documents (privacy, terms, security, DPA), which stay English deliberately. The chat answers in Greek on every page.
