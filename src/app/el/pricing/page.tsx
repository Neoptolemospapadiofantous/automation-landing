      ...
      <section className="relative pb-12">
        <div className="mx-auto max-w-[1280px] px-6">
          ...
          <p className="text-ink-dim mx-auto mt-3 max-w-[62ch] text-center text-[14px] leading-[1.6]">
            ...
            ιστοσελίδας — site παρουσίασης, μέχρι περίπου έξι σελίδες, με το
            chat εγκατεστημένο από την πρώτη μέρα. E-shop ή portal παραμένει
            δική του κατασκευή, με προσφορά. Ο σχεδιασμός γίνεται στο ίδιο
            δωρεάν 30λεπτο ραντεβού.
          </p>
