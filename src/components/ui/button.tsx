...
export const ctaClass = cva("inline-flex items-center justify-center", {
  variants: {
    ...
    size: {
      // px-5 below `sm`: a Greek page-level label («Δωρεάν Αναφορά Διαρροής →»)
      // is 3px too wide for a full-width button at 320 with px-6.
      lg: "px-5 py-4 text-[13px] font-semibold uppercase sm:px-6",
